export default function StatCard({label, value}: {label: string; value: string}) {
	return (
		<div className='w-full xl:w-63.75 px-6 py-2.5 md:p-4 lg:p-6 flex flex-row md:flex-col justify-between items-center gap-1 uppercase border border-neutral-0/20'>
